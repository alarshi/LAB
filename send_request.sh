...
do
  ...
  curl -X POST --data-binary "@post.json" https://outlook.office365.com/api/v1.0/me/sendmail --header "Content-Type:application/json" --insecure --verbose --user "asaxena@memphis.edu:Ivegot******"
